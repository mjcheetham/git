...
struct active_request_slot {
	...
	/*
	 * A `curl_slist` of request headers. Any slot returned by the
	 * `get_active_slot` function will have a fresh copy of the default
	 * headers. These headers will be assigned to the `curl` handle
	 * automatically in the call to `start_active_request`.
	 */
